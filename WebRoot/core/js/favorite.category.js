...
function edit(id)
{
	...
	var url = '/api/favorite/getCategory/' + id;
...
function saveCategory()
{
	...
	var url = '/api/favorite/saveCategory/';
...
function doBatch(type)
{
	...
	var url = '/api/favorite/batchCategory/';
...
function doDel(id)
{	 
	var url = '/api/favorite/deleteCategory/' + id;
	$.getJSON(url,function(data){
		if(data.error)
		{
			alert(data.error);
...
{
	var url = '/api/favorite/setCategoryOrder/?type=' + type + '&id=' + id;
	$.getJSON(url,function(data){
